...
class OrderDetailController extends GetxController {
  ...
  //     return;
  //   } else {
  //     // Parse details and order data
  //     final orderDetailsModel = OrderDetailsModel.fromJson(itemDetailsResp.rdata);
  //
  //     if (orderDetailsModel.details != null) {
  //       orderDetailData.value = orderDetailsModel.details!;  // Store details data
  //     } else {
  //       print('Error: Details data is null');
  //     }
  //
